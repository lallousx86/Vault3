...
public class ExportPhotosToDeviceDialog extends VaultDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		totalPhotosText.addModifyListener(new ModifyListener() {
			@Override
			public void modifyText(ModifyEvent e) {
				enableDisableOKButton();
			}
		...
		photosPerFolderText.addModifyListener(new ModifyListener() {
			@Override
			public void modifyText(ModifyEvent e) {
				enableDisableOKButton();
			}
		...
		parent.addHelpListener(new HelpListener() {
			...
			public void helpRequested(HelpEvent e) {
				HelpUtils.ProcessHelpRequest("Dialogs_ExportPhotosToDeviceDialog");
			}
		});
