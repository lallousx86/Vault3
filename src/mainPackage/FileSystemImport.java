...
public class FileSystemImport {
	...
	public static void importFromFileSystem(String rootFolderPath, Dictionary<String, Boolean> uniqueFileTypes, OutlineItem outlineItem, Dictionary<UUID, Boolean> nonEmptyOutlineItems) throws IOException {
				...
				for (File child : list) {
					if (child.isFile()) {
						...
						if (fileType != null) {
							...
							if (importFileType != null && importFileType.booleanValue()) {
