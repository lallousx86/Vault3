...
public class SearchUI extends Composite {
	...
	SearchUI(Composite parent) {
		...
		searchComboViewer.getCombo().addModifyListener(new ModifyListener() {
			@Override
			public void modifyText(ModifyEvent e) {
				searchButton.setEnabled(searchComboViewer.getCombo().getText().trim().length() > 0);
			}
		});
	...
	private void loadSavedSearches() {
	 ...
	 public boolean canGoToNextSearchTopic() {
	 ...
	 public boolean canGoToPreviousSearchTopic() {
