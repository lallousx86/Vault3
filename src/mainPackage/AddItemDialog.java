...
public class AddItemDialog extends VaultDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		titleWidget.addTraverseListener(new TraverseListener() {
	    ...
	    titleWidget.addModifyListener(new ModifyListener(){
		...
		photoFileText.addModifyListener(new ModifyListener() {
			@Override
			public void modifyText(ModifyEvent e) {
				enableDisableOKButton();
			}
		...
		parent.addHelpListener(new HelpListener() {
			...
			public void helpRequested(HelpEvent e) {
				HelpUtils.ProcessHelpRequest(mode == Mode.Add ? "Dialogs_AddItemDialog" : "Dialogs_EditItemDialog");
			}
		});
