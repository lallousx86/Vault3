...
public class CryptoGUIUtils {
	public static byte[] promptUserForPasswordAndDecrypt(Shell shell, String filePath, byte[] cipherText, StringWrapper password, VaultDocumentVersion vaultDocumentVersion) throws Exception {
		...
		do 
		{
			PasswordPromptDialog passwordPromptDialog = new PasswordPromptDialog(shell, new File(filePath).getName());
	...
	public static void promptUserForPasswordAndDecrypt(Shell shell, String filePath, String cipherText, StringWrapper password) throws Exception {
		boolean decrypted = false;
