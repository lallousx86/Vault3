...
public class AboutDialog extends VaultDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		new Label(composite, SWT.NONE).setText("(C) Copyright 2015, Eric Bergman-Terrell");
		...
		sqlite4JavaLink.addSelectionListener(new SelectionListener() {
			...
			@Override
			public void widgetSelected(SelectionEvent e) {
				Program.launch("http://code.google.com/p/sqlite4java/");
			}
		});
		...
		imagescalrLink.addSelectionListener(new SelectionListener() {
			...
			@Override
			public void widgetSelected(SelectionEvent e) {
				Program.launch("http://www.thebuzzmedia.com/software/imgscalr-java-image-scaling-library/");
			}
		});
		...
		parent.addHelpListener(new HelpListener() {
			...
			public void helpRequested(HelpEvent e) {
				HelpUtils.ProcessHelpRequest("Dialogs_AboutDialog");
			}
		});
