...
public class PDFExport {
	...
	public void exportOutlineItem(Document document, OutlineItem outlineItem, boolean tocOnly, int nestingDepth) throws DocumentException {
		...
		if (outlineItem.getFontList() == null)
		{
			if (defaultFontIsVariableWidth == null) {
				...
				try {
					...
					defaultFontIsVariableWidth = new Boolean(variableWidth);
