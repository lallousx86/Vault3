...
public class CryptoUtils {
	...
	public static SecretKey createSecretKeyVaultDocumentVersion_1_0(String password) throws NoSuchAlgorithmException {
	...
	public static SecretKey createSecretKeyVaultDocumentVersion_1_1(String password) throws NoSuchAlgorithmException, UnsupportedEncodingException {
	...
	public static byte[] decryptVaultDocumentVersion_1_0(String password, byte[] cipherText) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
	...
	public static byte[] decryptVaultDocumentVersion_1_1(String password, byte[] cipherText) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException, UnsupportedEncodingException {
        SecretKey secretKey = createSecretKeyVaultDocumentVersion_1_1(password);
